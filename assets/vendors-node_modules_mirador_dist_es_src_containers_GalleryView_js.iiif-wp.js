(self["webpackChunkiiif_wp"] = self["webpackChunkiiif_wp"] || []).push([["vendors-node_modules_mirador_dist_es_src_containers_GalleryView_js"],{

/***/ "./node_modules/mirador/dist/es/src/containers/GalleryView.js":
/*!********************************************************************************!*\
  !*** ./node_modules/mirador/dist/es/src/containers/GalleryView.js + 5 modules ***!
  \********************************************************************************/
...
var actions = __webpack_require__("./node_modules/mirador/dist/es/src/state/actions/index.js");
...
var annotation = __webpack_require__("./node_modules/mirador/dist/es/src/state/actions/annotation.js");
// EXTERNAL MODULE: ./node_modules/mirador/dist/es/src/state/actions/canvas.js
var actions_canvas = __webpack_require__("./node_modules/mirador/dist/es/src/state/actions/canvas.js");
...
/* harmony default export */ const Person = ((0,createSvgIcon.default)( /*#__PURE__*/react.createElement("path", {
...
var Avatar = /*#__PURE__*/react.forwardRef(function Avatar(props, ref) {
  var alt = props.alt,
      ...
      other = (0,objectWithoutProperties.default)(props, ["alt", "children", "classes", "className", "component", "imgProps", "sizes", "src", "srcSet", "variant"]);
  ...
  if (hasImgNotFailing) {
    children = /*#__PURE__*/react.createElement("img", (0,esm_extends.default)({
      alt: alt,
      src: src,
      srcSet: srcSet,
      sizes: sizes,
  ...
  return /*#__PURE__*/react.createElement(Component, (0,esm_extends.default)({
    className: (0,clsx_m.default)(classes.root, classes.system, classes[variant], className, !hasImgNotFailing && classes.colorDefault),
    ref: ref
  }, other), children);
});
 true ? Avatar.propTypes = {
   ...
   */
  classes: (0,chainPropTypes.default)((prop_types_default()).object, function (props) {
   ...
   */
  variant: (0,chainPropTypes.default)(prop_types_default().oneOf(['circle', 'circular', 'rounded', 'square']), function (props) {
...
/* harmony default export */ const Avatar_Avatar = ((0,withStyles.default)(styles, {
  name: 'MuiAvatar'
})(Avatar));
...
// EXTERNAL MODULE: ./node_modules/@researchgate/react-intersection-observer/lib/es/index.js + 5 modules
var lib_es = __webpack_require__("./node_modules/@researchgate/react-intersection-observer/lib/es/index.js");
...
var IIIFThumbnail = __webpack_require__("./node_modules/mirador/dist/es/src/containers/IIIFThumbnail.js");
...
var GalleryViewThumbnail = /*#__PURE__*/function (_Component) {
  ...
  _createClass(GalleryViewThumbnail, [{
    ...
    value: function render() {
      ...
      var miradorCanvas = new MiradorCanvas.default(canvas);
      return /*#__PURE__*/react.createElement(lib_es.default, {
        ...
        role: "button",
        tabIndex: 0
      }, /*#__PURE__*/react.createElement(IIIFThumbnail.default, {
        resource: canvas,
        labelled: true,
        variant: "outside",
      ...
      }, searchAnnotationsCount > 0 && /*#__PURE__*/react.createElement(Chip.default, {
        avatar: /*#__PURE__*/react.createElement(Avatar_Avatar, {
          className: classes.avatar,
          classes: {
            circle: classes.avatarIcon
          }
        }, /*#__PURE__*/react.createElement(SearchSharp.default, {
          fontSize: "small"
        })),
        label: searchAnnotationsCount,
        className: classnames_default()(classes.searchChip),
        size: "small"
      }), (annotationsCount || 0) > 0 && /*#__PURE__*/react.createElement(Chip.default, {
        avatar: /*#__PURE__*/react.createElement(Avatar_Avatar, {
          className: classes.avatar,
          classes: {
            circle: classes.avatarIcon
          }
        }, /*#__PURE__*/react.createElement(CommentSharp.default, {
...
var selectors_annotations = __webpack_require__("./node_modules/mirador/dist/es/src/state/selectors/annotations.js");
...
var mapStateToProps = function mapStateToProps(state, _ref) {
  ...
  var currentCanvas = (0,canvases.getCurrentCanvas)(state, {
    windowId: windowId
  });
  var searchAnnotations = (0,searches.getSearchAnnotationsForWindow)(state, {
    windowId: windowId
  });
  ...
  var hasOpenAnnotationsWindow = (0,companionWindows.getCompanionWindowsForContent)(state, {
    content: 'annotations',
    windowId: windowId
  }).length > 0;
  return {
    annotationsCount: function () {
      ...
      var annotations = (0,selectors_annotations.getPresentAnnotationsOnSelectedCanvases)(state, {
        canvasId: canvas.id
      });
    ...
    config: (0,config.getConfig)(state).galleryView,
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, _ref2) {
  ...
  return {
    focusOnCanvas: function focusOnCanvas() {
      return dispatch(actions_window.setWindowViewType(windowId, 'single'));
    },
    requestCanvasAnnotations: function requestCanvasAnnotations() {
      return dispatch(annotation.requestCanvasAnnotations(windowId, canvas.id));
    },
    setCanvas: function setCanvas() {
      ...
      return dispatch(actions_canvas.setCanvas.apply(actions, [windowId].concat(args)));
    }
  };
};

var enhance = (0,redux.compose)((0,es.connect)(mapStateToProps, mapDispatchToProps), (0,withStyles.default)(GalleryViewThumbnail_styles) // further HOC go here
);
...
function GalleryView_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
  ...
  GalleryView_createClass(GalleryView, [{
    ...
    function render() {
      ...
      return /*#__PURE__*/react.createElement(Paper.default, {
        ...
        return /*#__PURE__*/react.createElement(containers_GalleryViewThumbnail, {
          key: canvas.id,
          windowId: windowId,
          canvas: canvas
        });
...
var GalleryView_mapStateToProps = function mapStateToProps(state, _ref) {
  ...
  return {
    canvases: (0,canvases.getCanvases)(state, {
      windowId: windowId
    }),
    viewingDirection: (0,sequences.getSequenceViewingDirection)(state, {
      windowId: windowId
    })
  };
};
...
var GalleryView_enhance = (0,redux.compose)((0,withStyles.default)(GalleryView_styles), (0,es.connect)(GalleryView_mapStateToProps), (0,withPlugins.withPlugins)('GalleryView') // further HOC go here
);
...
//# sourceMappingURL=vendors-node_modules_mirador_dist_es_src_containers_GalleryView_js.iiif-wp.js.map